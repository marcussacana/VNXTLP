...
namespace Tema {
    ...
    public class Tema_ThemeContainer : ContainerControl {
    ...
    public class Tema_ControlBox : Control {
    ...
    class Tema_Toggle : Control {
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            checked {
                ...
                G.SmoothingMode = SmoothingMode.AntiAlias;
                G.FillPath(Gradient, (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new Tema_Toggle.PillStyle {
                    Left = true,
                    Right = true
                }));
                G.DrawPath(new Pen(Color.FromArgb(177, 177, 176)), (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new Tema_Toggle.PillStyle {
                    Left = true,
                    Right = true
                }));
                Gradient.Dispose();
                switch (this.ToggleType) {
                    case Tema_Toggle._Type.YesNo: {
    ...
    class Tema_LinkLabel : LinkLabel {

        public Tema_LinkLabel() {
            Font = new Font("Segoe UI", 8, FontStyle.Regular);
            BackColor = Color.Transparent;
    ...
    class Tema_HeaderLabel : Label {

        public Tema_HeaderLabel() {
    ...
    class Tema_TextBox_Big : Control {
        #region Variables

        public TextBox TemaTB = new TextBox();
        private GraphicsPath Shape;
        ...
        public void AddTextBox() {
            ...
            _TB.Multiline = false;
            TemaTB.KeyDown += _OnKeyDown;
            TemaTB.TextChanged += OnBaseTextChanged;
        }

        public Tema_TextBox_Big() {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e) {
            ...
            TemaTB.TextAlign = TextAlignment;
            TemaTB.UseSystemPasswordChar = UseSystemPasswordChar;
    ...
    [DefaultEvent("TextChanged")]
    class Tema_TextBox_Small : Control {
        #region Variables
    ...
    [DefaultEvent("TextChanged")]
    class Tema_RichTextBox : Control {

        #region Variables

        public RichTextBox TemaRTB = new RichTextBox();
        private bool _ReadOnly;
        ...
        protected override void OnSizeChanged(System.EventArgs e) {
            base.OnSizeChanged(e);
            TemaRTB.Size = new Size(Width - 13, Height - 11);
        }
    ...
    public class Tema_NumericUpDown : Control {
    ...
    public class Tema_ChatBubble_L : Control {
    ...
    public class Tema_ChatBubble_R : Control {
    ...
    public class Tema_Separator : Control {

        public Tema_Separator() {
    ...
    class Tema_Panel : ContainerControl {
    ...
    public class Tema_GroupBox : ContainerControl {

        public Tema_GroupBox() {
    ...
    [DefaultEvent("CheckedChanged")]
    class Tema_RadioButton : Control {
        ...
        private void InvalidateControls() {
            ...
            foreach (Control _Control in Parent.Controls) {
                if (!object.ReferenceEquals(_Control, this) && _Control is Tema_RadioButton) {
                    ((Tema_RadioButton)_Control).Checked = false;
                }
            }
        }
    ...
    class Tema_NotificationNumber : Control {
        #region Variables
        ...
        public Tema_NotificationNumber() {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);
    ...
    class Tema_Listview : ListView {

        [DllImport("uxtheme", CharSet = CharSet.Unicode)]
        public static extern int SetWindowTheme(IntPtr hWnd, string textSubAppName, string textSubIdList);

        public Tema_Listview() {
    ...
    public class Tema_ProgressBar : Control {
    ...
    class Tema_ProgressIndicator : Control {
    ...
    class Tema_TabControl : TabControl {

        public Tema_TabControl() {
    ...
    public class Tema_MenuStrip : MenuStrip {

        public Tema_MenuStrip() {
    ...
    public class Tema_ContextMenuStrip : ContextMenuStrip {

        public Tema_ContextMenuStrip() {
            this.Renderer = new ControlRenderer();
        }
    ...
    public class Tema_StatusStrip : StatusStrip {

        public Tema_StatusStrip() {
            this.Renderer = new ControlRenderer();
            SizingGrip = false;
        }
    ...
    class Tema_Icon_Info : Control {
        public Tema_Icon_Info() {
    ...
    class Tema_Icon_Tick : Control {

        public Tema_Icon_Tick() {
            this.ForeColor = Color.DimGray;
            this.BackColor = Color.FromArgb(246, 246, 246);
            this.Size = new Size(33, 33);
            DoubleBuffered = true;
    ...
    public class Tema_HorizontalScrollBar : Control {
        ...
        public Tema_HorizontalScrollBar() {
    ...
    public class Thema_ControlBox : Control {
        ...
        protected override void OnMouseUp(System.Windows.Forms.MouseEventArgs e) {
            ...
            else if (X > (_EnableMinimize ? 43 : 23) && X < (_EnableMinimize? 60 : 40)) {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e) {
            ...
            Rectangle MaxBtn = new Rectangle(_EnableMinimize ? 43 : 23, 2, 17, 17);
            ...
            G.DrawString("r", new Font("Marlett", 7), new SolidBrush(Color.FromArgb(52, 50, 46)), new Rectangle(6, 8, 0, 0));
            ...
            if (_EnableMinimize) {
                ...
                G.DrawString("0", new Font("Marlett", 7), new SolidBrush(Color.FromArgb(52, 50, 46)), new Rectangle(26, 4, 0, 0));
            }
            if (_EnableMaximize) {
                ...
                G.DrawString("1", new Font("Marlett", 7), new SolidBrush(Color.FromArgb(52, 50, 46)), new Rectangle(_EnableMinimize ? 46 : 26, 7, 0, 0));
            }
            ...
            switch (State) {
                ...
                case MouseState.Over:
                    ...
                    if (X > (_EnableMinimize ? 43 : 23) && X < (_EnableMinimize? 60 : 40)) {
