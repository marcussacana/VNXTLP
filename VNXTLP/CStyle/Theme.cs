...
namespace CTema
{
    ...
    public class ControlRenderer : ToolStripProfessionalRenderer
    {
        ...
        {
            //base.OnRenderItemCheck(e);//Remove Windows Checked

            Rectangle rect = new Rectangle(3, 1, e.Item.Height - 1, e.Item.Height - 3);
    ...
    public class RectDrawing
    {
        ...
        public static void DrawSelection(Graphics G, xColorTable ColorTable, Rectangle Rect)
        {
            ...
            {
                DrawRoundedRectangle(G, P1, System.Convert.ToSingle(Rect.X), System.Convert.ToSingle(Rect.Y), System.Convert.ToSingle(Rect.Width), System.Convert.ToSingle(Rect.Height), 2);
            }
    ...
    public class CTema_ThemeContainer : ContainerControl
    {
        ...
        protected sealed override void OnParentChanged(EventArgs e)
        {
            ...
            if (!_ControlMode)
            {
                ...
                if (_IsParentForm)
                {
                    ...
                    this.ParentForm.TransparencyKey = Color.FromArgb(103, 99, 100);
        ...
        protected override void OnCreateControl()
        {
            ...
            this.ParentForm.FormBorderStyle = FormBorderStyle.None;
            this.ParentForm.TransparencyKey = Color.FromArgb(103, 100, 100);
        }
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillPath(new SolidBrush(Color.FromArgb(103, 99, 100)), RoundRectangle.RoundRect(ClientRectangle, BorderCurve));

            G.DrawPath(new Pen(Color.FromArgb(103, 99, 100), 3), RoundRectangle.RoundRect(ClientRectangle, BorderCurve - 1));

            G.FillPath(new SolidBrush(Color.FromArgb(222, 222, 223)), RoundRectangle.RoundRect(new Rectangle(-1, 30, Width + 1, Height - 52), BorderCurve));

            G.DrawString(Text, new Font("Trebuchet MS", 10, FontStyle.Bold), new SolidBrush(Color.FromArgb(221, 221, 221)), new Rectangle(BorderCurve, BorderCurve - 11, Width - 1, 22), new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Near });

            G.DrawString(_TextBottom, new Font("Segoe UI", 10, FontStyle.Regular), new SolidBrush(Color.FromArgb(221, 221, 221)), 25, Height - 20);
    ...
    public class CTema_ControlBox : Control
    {
    ...
    class CTema_Button_1 : Control
    {
        ...
        public CTema_Button_1()
        {
            ...
            P1 = new Pen(Color.FromArgb(190, 190, 190));
        }
    ...
    class CTema_Toggle : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            checked
            {
                ...
                G.SmoothingMode = SmoothingMode.AntiAlias;
                G.FillPath(Gradient, (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new CTema_Toggle.PillStyle
                {
                    Left = true,
                    Right = true
                }));
                G.DrawPath(new Pen(Color.FromArgb(177, 177, 176)), (GraphicsPath)this.Pill(0, (int)Math.Round(unchecked((double)this.Height / 2.0 - (double)this.cHandle.Height / 2.0)), this.Width - 1, this.cHandle.Height - 5, new CTema_Toggle.PillStyle
                {
                    Left = true,
                    Right = true
                }));
    ...
    class CTema_LinkLabel : LinkLabel
    {

        public CTema_LinkLabel()
        {
            Font = new Font("Segoe UI", 8, FontStyle.Regular);
            BackColor = Color.Transparent;
    ...
    class CTema_HeaderLabel : Label
    {

        public CTema_HeaderLabel()
        {
    ...
    class CTema_TextBox_Big : Control
    {
        #region Variables

        public TextBox CTemaTB = new TextBox();
        private GraphicsPath Shape;
        ...
        public bool UseSystemPasswordChar
        {
            ...
            set
            {
                CTemaTB.UseSystemPasswordChar = UseSystemPasswordChar;
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (CTemaTB != null)
                {
                    CTemaTB.Multiline = value;

                    if (value)
                    {
                        CTemaTB.Height = Height - 23;
                    }
                    else
                    {
                        Height = CTemaTB.Height + 23;
                    }
                }
        ...
        public Image Image
        {
            ...
            set
            {
                ...
                if (Image == null)
                {
                    CTemaTB.Location = new Point(8, 10);
                }
                else
                {
                    CTemaTB.Location = new Point(35, 11);
                }
                Invalidate();
            }
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            Shape = new GraphicsPath();
            var _with1 = Shape;
            _with1.AddRectangle(new Rectangle(new Point(0,0), new Size(Width -1, Height -1)));
        ...
        public void AddTextBox()
        {
            ...
            _TB.Multiline = false;
            CTemaTB.KeyDown += _OnKeyDown;
            CTemaTB.TextChanged += OnBaseTextChanged;
        }

        public CTema_TextBox_Big()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);

            AddTextBox();
            Controls.Add(CTemaTB);
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (Image == null)
            {
                CTemaTB.Width = Width - 18;
            }
            else
            {
                CTemaTB.Width = Width - 45;
            }

            CTemaTB.TextAlign = TextAlignment;
            CTemaTB.UseSystemPasswordChar = UseSystemPasswordChar;
    ...
    [DefaultEvent("TextChanged")]
    class CTema_TextBox_Small : Control
    {
        #region Variables
        ...
        public bool Multiline
        {
            ...
            set
            {
                ...
                if (CTemaTB != null)
                {
                    ...
                    if (value)
                    {
                        CTemaTB.Height = Height - 10;
                    }
                    else
                    {
                        Height = CTemaTB.Height + 10;
                    }
                }
            }
        }
    ...
    [DefaultEvent("TextChanged")]
    class CTema_RichTextBox : Control
    {

        #region Variables

        public RichTextBox CTemaRTB = new RichTextBox();
        private bool _ReadOnly;
        ...
        public bool AutoWordSelection
        {
            ...
            set
            {
                ...
                if (CTemaRTB != null)
                {
                    CTemaRTB.AutoWordSelection = value;
                }
            }
        }
        #endregion
        ...
        {
            base.OnSizeChanged(e);
            CTemaRTB.Size = new Size(Width - 13, Height - 11);
        }
    ...
    public class CTema_NumericUpDown : Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillRectangle(ColorGradient, ColorGradient.Rectangle);
    ...
    public class CTema_ChatBubble_L : Control
    {

        #region Variables

        private GraphicsPath Shape;
        private Color _TextColor = Color.FromArgb(103, 99, 100);
        ...
        public CTema_ChatBubble_L()
        {
            SetStyle(ControlStyles.AllPaintingInWmPaint | ControlStyles.OptimizedDoubleBuffer | ControlStyles.ResizeRedraw | ControlStyles.SupportsTransparentBackColor | ControlStyles.UserPaint, true);
            DoubleBuffered = true;
            Size = new Size(152, 38);
            BackColor = Color.Transparent;
            ForeColor = Color.FromArgb(103, 99, 100);
    ...
    public class CTema_ChatBubble_R : Control
    {
    ...
    public class CTema_Separator : Control
    {

        public CTema_Separator()
        {
    ...
    class CTema_Panel : ContainerControl
    {
    ...
    public class CTema_GroupBox : ContainerControl
    {

        public CTema_GroupBox()
        {
    ...
    [DefaultEvent("CheckedChanged")]
    class CTema_RadioButton : Control
    {
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (!object.ReferenceEquals(_Control, this) && _Control is CTema_RadioButton)
                {
                    ((CTema_RadioButton)_Control).Checked = false;
                }
            }
        }
    ...
    class CTema_NotificationNumber : Control
    {
        #region Variables
        ...
        public CTema_NotificationNumber()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);
    ...
    class CTema_Listview : ListView
    {

        [DllImport("uxtheme", CharSet = CharSet.Unicode)]
        public static extern int SetWindowTheme(IntPtr hWnd, string textSubAppName, string textSubIdList);

        public CTema_Listview()
        {
    ...
    #region CheckListBox
    class CTema_CheckedListBox : CheckedListBox
    {
        private Color _Color1 = Color.FromArgb(103, 99, 100);
        private Color _Color2 = Color.FromArgb(131, 129, 129);
        private Color _NumberLineColor = Color.FromArgb(53, 49, 50);
        ...
        {
            get { return _NumberLineColor; }
            set { _NumberLineColor = value; Invalidate(); }
        }

        public CTema_CheckedListBox()
        {
            Font = new Font("Segoe UI", 12, FontStyle.Regular);
            ForeColor = Color.FromArgb(233, 234, 235);
            BackColor = Color.FromArgb(103, 99, 100);
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            LimitX = e.Bounds.Location.X;
            LimitY = e.Bounds.Location.Y;

            StringFormat sf = new StringFormat();
            sf.LineAlignment = StringAlignment.Center;
            sf.Alignment = StringAlignment.Center;

            FontSize = (e.Index <= 1000 ? 10 : 7);



            if (e.Index >= 0)
            {
                var Rectangle = new Rectangle(new Point(LimitX + 33, LimitY), e.Bounds.Size);
                e = new DrawItemEventArgs(e.Graphics, e.Font, Rectangle, e.Index, e.State, ForeColor, (e.Index % 2 == 0) ? _Color1 : _Color2);
                e.Graphics.FillRectangle(new SolidBrush((e.Index % 2 == 0) ? _Color1 : _Color2), new Rectangle(new Point(19, e.Bounds.Y), new Size(0, 23)));
                e.Graphics.DrawString((e.Index).ToString(), new Font("Segoe UI", FontSize), 
                                new SolidBrush(_NumberLineColor),
                                new Rectangle(new Point(19, e.Bounds.Y), new Size(0, 23)),
                                new StringFormat(sf));
            }
    ...
    public class CTema_ProgressBar : Control
    {
    ...
    class CTema_ProgressIndicator : Control
    {
        ...
        public Size P_CircleSize
        {
            get { return CircleSize; }
            set
            {
                if (CircleSize.Height != value.Height)
                    CircleSize = new Size(value.Height, value.Height);
                if (CircleSize.Width != value.Width)
                    CircleSize = new Size(value.Width, value.Width);
                Invalidate();
            }
        }
        #endregion
        ...
        public CTema_ProgressIndicator()
        {
        ...
        private void SetPoints()
        {
            ...
            {
                this.SetValue(startingFloatPoint, (int)Math.Round(Width / 2.0 - 15.0), i);
    ...
    class CTema_TabControl : TabControl
    {

        public CTema_TabControl()
        {
    ...
    public class CTema_MenuStrip : MenuStrip
    {

        public CTema_MenuStrip()
        {
    ...
    public class CTema_ContextMenuStrip : ContextMenuStrip
    {

        public CTema_ContextMenuStrip()
        {
            this.Renderer = new ControlRenderer();
        }
    ...
    public class CTema_StatusStrip : StatusStrip
    {

        public CTema_StatusStrip()
        {
            this.Renderer = new ControlRenderer();
            SizingGrip = false;
        }
    ...
    class CTema_Icon_Info : Control
    {
        public CTema_Icon_Info()
        {
    ...
    class CTema_Icon_Tick : Control
    {

        public CTema_Icon_Tick()
        {
            this.ForeColor = Color.DimGray;
            this.BackColor = Color.FromArgb(246, 246, 246);
            this.Size = new Size(33, 33);
    ...
    public class CTema_HorizontalScrollBar : Control
    {
        private InnerLineCount _AmountOfInnerLines = InnerLineCount.None;
        public Color ArrowHoveerColour = Color.FromArgb(0x27, 0x7b, 0xb5);
        public Color ArrowNormalColour = Color.FromArgb(0x99, 0x99, 0x99);
        public Color ArrowPressedColour = Color.FromArgb(0, 0x71, 0xab);
        private MouseState _ArrowState;
        public Color BarColour = Color.FromArgb(246, 246, 246);
        private int _ButtonSize = 0x10;
        ...
        public Color ThumbHoverColour = Color.FromArgb(0x4D, 0x4D, 0x4D);
        public Color ThumbNormalColour = Color.FromArgb(0x68, 0x68, 0x68);
        public Color ThumbPressedColour = Color.FromArgb(0x32, 0x32, 0x32);
        ...
        public CTema_HorizontalScrollBar()
        {
            _MousePos = new Point(_MouseXLoc, _MouseYLoc);
            _ThumbState = MouseState.None;
            _ArrowState = MouseState.None;
            _ThumbSize = 0x18;
            SetStyle(ControlStyles.OptimizedDoubleBuffer | ControlStyles.AllPaintingInWmPaint | ControlStyles.SupportsTransparentBackColor | ControlStyles.Selectable | ControlStyles.ResizeRedraw | ControlStyles.UserPaint, true);
            DoubleBuffered = true;
            Size = new Size(50, 0x13);
        }

        private void InvalidateLayout()
        {
            LSA = new Rectangle(0, 0, 0x10, Height);
            RSA = new Rectangle(Width - ButtonSize, 0, ButtonSize, Height);
            Shaft = new Rectangle(LSA.Right + 1, 0, (int)Math.Round((Width - Width / 8.0) - 8.0), Height);
            ShowThumb = (_Maximum - _Minimum) > 0;
            if (ShowThumb)
            {
                Thumb = new Rectangle(0, 4, (int)Math.Round(Width / 8.0), Height - 8);
            }
            InvalidatePosition();
        }
        ...
        {
            Thumb.X = (int)Math.Round((_Value - _Minimum) / ((double)(_Maximum - _Minimum)) * (Shaft.Width - _ThumbSize) + 16.0);
            Scroll?.Invoke(this);
            Invalidate();
        }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            {
                int num = ((e.X + 2) - LSA.Width) - (_ThumbSize / 2);
                int num2 = Shaft.Width - _ThumbSize;
                ThumbMovement = ((int)Math.Round(num / ((double)num2) * (_Maximum - _Minimum))) - _Minimum;
                Value = Math.Min(Math.Max(ThumbMovement, _Minimum), _Maximum);
                InvalidatePosition();
            }
        }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if ((e.Location.X < 0x10) | (e.Location.X > (Width - 0x10)))
            {
                _ThumbState = MouseState.Over;
            }
            else if ((e.Location.X >= 0x10) | (e.Location.X > (Width - 0x10)))
            {
                _ThumbState = MouseState.None;
            }
            base.Invalidate();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graphics2.Clear(BarColour);
            Point[] points = new Point[] { new Point(5, (int)Math.Round(Height / 2.0)), new Point(11, (int)Math.Round(Height / 4.0)), new Point(11, (int)Math.Round(Height / 2.0 + Height / 4.0)) };
            Point[] pointArray2 = new Point[] { new Point(Width - 5, (int)Math.Round(Height / 2.0)), new Point(Width - 11, (int)Math.Round(Height / 4.0)), new Point(Width - 11, (int)Math.Round(Height / 2.0 + Height / 4.0)) };
            switch (_ThumbState)
            {
                case MouseState.None:
                    using (SolidBrush brush = new SolidBrush(ThumbNormalColour))
                    {
                        graphics2.FillRectangle(brush, Thumb);
                    }
                    break;

                case MouseState.Over:
                    using (SolidBrush brush2 = new SolidBrush(ThumbHoverColour))
                    {
                        graphics2.FillRectangle(brush2, Thumb);
                    }
                    break;

                case MouseState.Down:
                    using (SolidBrush brush3 = new SolidBrush(ThumbPressedColour))
                    {
                        graphics2.FillRectangle(brush3, Thumb);
                    }
                    break;
            }
            switch (_ArrowState)
            {
                case MouseState.None:
                    graphics2.FillPolygon(new SolidBrush(ArrowNormalColour), points);
                    graphics2.FillPolygon(new SolidBrush(ArrowNormalColour), pointArray2);
                    break;

                case MouseState.Over:
                    if (_MouseXLoc >= 0x10)
                    {
                        if (_MouseXLoc > (Width - 0x10))
                        {
                            graphics2.FillPolygon(new SolidBrush(ArrowHoveerColour), pointArray2);
                            graphics2.FillPolygon(new SolidBrush(ArrowNormalColour), points);
                        }
                        else
                        {
                    ...
                    graphics2.FillPolygon(new SolidBrush(ArrowHoveerColour), points);
                    graphics2.FillPolygon(new SolidBrush(ArrowNormalColour), pointArray2);
                    break;
                ...
                case MouseState.Down:
                    ...
                    {
                        using (SolidBrush brush4 = new SolidBrush(ThumbNormalColour))
                        {
                            graphics2.FillRectangle(brush4, Thumb);
                        }
                    }
                    if (_MouseXLoc < 0x10)
                    {
                        graphics2.FillPolygon(new SolidBrush(ArrowPressedColour), points);
                        graphics2.FillPolygon(new SolidBrush(ArrowNormalColour), pointArray2);
                    }
                    else if (_MouseXLoc > (base.Width - 0x10))
                    {
                        graphics2.FillPolygon(new SolidBrush(ArrowPressedColour), pointArray2);
                        graphics2.FillPolygon(new SolidBrush(ArrowNormalColour), points);
                    }
                    else
                    {
    ...
    public class Thema_ControlBox : Control
    {
        ...
        protected override void OnMouseUp(System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (X > 3 && X < 20 && _EnableMinimize)
            {
                FindForm().WindowState = FormWindowState.Minimized;
            }
            else if (X > 23 && X < 40 && _EnableMinimize)
            {
                if (_EnableMaximize)
                {

                    if (FindForm().Size != Screen.PrimaryScreen.WorkingArea.Size)
                    {

                        MeWidth = FindForm().Size.Width;
                        MeHeigth = FindForm().Size.Height;
                        MePointX = FindForm().Location.X;
                        MePointY = FindForm().Location.Y;
                        FindForm().Location = new Point(0, 0);
                        FindForm().Size = Screen.PrimaryScreen.WorkingArea.Size;
                        
                    }
                    else
                    {

                        FindForm().Size = new Size(MeWidth, MeHeigth);
                        FindForm().Location = new Point(MePointX, MePointY);
                    }
                }
            }
            else if (X > 43  && X < 60)
        ...
        public bool _EnableMinimize = true;
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e) {
            ...
            G.DrawString("r", new Font("Marlett", 14), new SolidBrush(Color.White), new Rectangle(42, 5, 0, 0));

            G.DrawString("0", new Font("Marlett", 14), new SolidBrush(_EnableMinimize ? Color.White : Color.Transparent), new Rectangle(2, 0, 0, 0));
            
            G.DrawString("1", new Font("Marlett", 14), new SolidBrush(_EnableMaximize ? Color.White : Color.Transparent), new Rectangle(22, 4, 0, 0));
            ...
            switch (State) {
                ...
                case MouseState.Over:
                    if (X > 3 && X < 20) {
                        G.DrawString("0", new Font("Marlett", 14), new SolidBrush(_EnableMinimize ? Color.Red : Color.Transparent), new Rectangle(2, 0, 0, 0));
                    }
                    if (X > 23 && X < 40) {
                        G.DrawString("1", new Font("Marlett", 14), new SolidBrush(_EnableMaximize ? Color.Red : Color.Transparent), new Rectangle(22, 4, 0, 0));
                    }
                    if (X > 43 && X < 60) {
                        G.DrawString("r", new Font("Marlett", 14), new SolidBrush(Color.Red), new Rectangle(42, 5, 0, 0));
                    }
                    break;
            }
